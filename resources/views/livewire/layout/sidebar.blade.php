...
<div>
    <!-- Sidebar -->
    <aside class="fixed inset-y-0 left-0 z-50 w-64 sm:w-72 lg:w-64 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 shadow-2xl" :class="{ '-translate-x-full': !sidebarOpen }">
        ...
        <!-- Navigation -->
        <nav class="flex-1 px-3 py-4 space-y-6 overflow-y-auto h-[calc(100vh-8rem)] scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
            ...
            @canany(['sales.view', 'sales.create', 'resellers.manage', 'returns.manage'])
            <div>
                <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 flex items-center gap-2">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('sales.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('sales.index'),
                    ])>
                    ...
                    <a href="{{ route('sales.create') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('sales.create'),
                    ])>
                    ...
                    @can('resellers.manage')
                     <a href="{{ route('resellers.index') }}" @class([
                        'flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 group',
                        'bg-white/10 text-white' => request()->routeIs('resellers.*') && !request()->routeIs('sales.resellers'),
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('resellers.*') || request()->routeIs('sales.resellers'),
                    ])>
                    ...
                    <a href="{{ route('sales.resellers') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('sales.resellers'),
                    ])>
                        ...
                        @if($pendingCount > 0)
                            <span class="ml-auto inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold leading-none text-white bg-red-500 rounded-full animate-pulse shadow-lg">
                                {{ $pendingCount }}
                            </span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('sales.payments.pending') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('sales.payments.pending'),
                    ])>
                        <i data-lucide="credit-card" class="w-4 h-4 flex-shrink-0"></i>
                        <span>Paiements</span>
                        @php $unpaidCount = \App\Models\Sale::withPendingPayment()->count(); @endphp
                         @if($unpaidCount > 0)
                            <span class="ml-auto inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold leading-none text-white bg-amber-500 rounded-full shadow-lg">
                                {{ $unpaidCount }}
                            </span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('trade-ins.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('trade-ins.index'),
                    ])>
                        <i data-lucide="repeat" class="w-4 h-4 flex-shrink-0"></i>
                        <span>Trocs</span>
                    </a>
                    @endcan
                    ...
                    <a href="{{ route('returns.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('returns.*'),
                    ])>
                        <i data-lucide="arrow-left-circle" class="w-4 h-4 flex-shrink-0"></i>
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('products.index') }}" @class([
                        'flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 group',
                        'bg-white/10 text-white' => request()->routeIs('products.*') && !request()->routeIs('product-models.*'),
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('products.*') || request()->routeIs('product-models.*'),
                    ])>
                    ...
                    <a href="{{ route('product-models.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('product-models.*'),
                    ])>
                    ...
                    <a href="{{ route('stock-movements.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('stock-movements.*'),
                    ])>
                    ...
                    <a href="{{ route('products.supplier-returns') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('products.supplier-returns'),
                    ])>
                        <i data-lucide="truck" class="w-4 h-4 flex-shrink-0"></i>
                        <span>Retours fourn.</span>
                    </a>
                    @endcan
                </div>
            </div>
                ...
                <div class="space-y-1">
                    ...
                    @if(auth()->user()->isVendeur())
                        <a href="{{ route('reports.daily') }}" @class([
                            ...
                            'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('reports.daily'),
                        ])>
                    ...
                    @if(auth()->user()->isAdmin())
                        <a href="{{ route('reports.daily') }}" @class([
                            ...
                            'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('reports.*'),
                        ])>
                    ...
                    <a href="{{ route('users.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('users.*'),
                    ])>
                    ...
                    <a href="{{ route('activity-logs.index') }}" @class([
                        ...
                        'text-gray-400 hover:bg-gray-800/50 hover:text-white' => !request()->routeIs('activity-logs.index'),
                    ])>
