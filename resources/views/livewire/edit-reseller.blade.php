<div>
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex items-center justify-between gap-4 bg-white border border-gray-200 rounded-lg p-6">
            <div>
                <button type="button" wire:click="delete" wire:confirm="Êtes-vous sûr de vouloir supprimer ce revendeur ?" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 border border-red-600 rounded-md font-medium text-sm text-white hover:bg-red-700 transition-colors">
            ...
            <div class="flex items-center gap-2">
                ...
                <button type="submit" wire:loading.attr="disabled" class="inline-flex items-center gap-2 px-6 py-2 bg-gray-900 border border-gray-900 rounded-md font-medium text-sm text-white hover:bg-gray-800 transition-colors disabled:opacity-50">
                    ...
                    <span wire:loading.remove wire:target="submit">Mettre à jour</span>
                    <span wire:loading wire:target="submit">Mise à jour...</span>
                </button>
            </div>
        </div>
    </form>
